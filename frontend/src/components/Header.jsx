...
export default function Header({ selectedSection, isAuthenticated, onSectionClick }) {
    ...
    <header className='bg-slate-50 w-full py-2 flex items-center justify-between px-10 text-slate-700'>
      ...
      >
        <div className='flex flex-col items-center'>
          ...
          <p className='px-3 py-2 hover:bg-slate-100 transition-all ease-in-out duration-300x@xx@ w-11/12 rounded-md text-left'>
